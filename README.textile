...
The checker script contains a test suite to verify operations using example files under @test/fixtures@.

Use @rake test@ to run the tests. 

The output will tell you what files were loaded and how long the suite took to run. It will also report the number of tests, assertions, failures and errors. 
